...
func main() {
	...
	res, err := service.Client.Embeddings.New(ctx, openai.EmbeddingNewParams{
		Model: openai.EmbeddingModelTextEmbedding3Small,
		Input: openai.EmbeddingNewParamsInputUnion{OfString: openai.String(sText)},
	})
	if err != nil {
	...
	fmt.Println("Embeddings: ", res.RawJSON())
}
